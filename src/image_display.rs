...
impl ImageDisplay {
    ...
    pub fn render_image(&mut self, image_path: &str, block: Rect, terminal: Rect) -> Result<()> {
    ...
    fn w3m_input(&mut self, image_path: &str, block: Rect, terminal: Rect) -> Result<String> {
